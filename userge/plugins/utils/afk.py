...
@userge.on_cmd("afk", about={
    ...
    'header': "Pengaturan mode AFK ngabb",

    'description': "Atur status AFK lu. Respon ke orang yang tags/PM's.\n"

                   "lu kasih tau kalau lu AFK. Mematikan fungsi AFK cukup chat sembarang ngabb.",

    'usage': "{tr}afk or {tr}afk [alasan]"}, allow_channels=False)

async def active_afk(message: Message) -> None:

    """ hidup dan matikan mode AFK """
...
async def handle_afk_incomming(message: Message) -> None:
    ...
    if user_id in USERS:
        ...
        if not (USERS[user_id][0] + USERS[user_id][1]) % randint(2, 4):
            ...
            if REASON:
                ...
                out_str = (f"Gua lagi **AFK** ngabb.\nAlasan: <code>{ALASAN}</code>\n"
    ...
    if chat.type == 'private':
        ...
        coro_list.append(CHANNEL.log(
            ...
            f"#PRIVATE\n{user_dict['mention']} mengirim kamu\n\n"
        ...
        coro_list.append(CHANNEL.log(
            ...
            f"{user_dict['mention']} nandain lu di [{chat.title}](http://t.me/{chat.username})\n\n"
...
async def handle_afk_outgoing(message: Message) -> None:
    ...
    if USERS:
        ...
        coro_list.append(replied.edit(
            ...
            f"`Lu nerima {p_count + g_count} pesan saat lu off ngab. "

            f"Cek log untuk lebih detail.`\n\n**Waktu AFK** : __{afk_time}__", del_in=3))

        out_str = f"Lu nerima **{p_count + g_count}** pesan " + \

            f"dari **{len(USERS)}** ketika lu off!\n\n**Waktu AFK** : __{afk_time}__\n"
