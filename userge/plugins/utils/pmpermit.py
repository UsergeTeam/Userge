...
@userge.on_cmd("allow", about={
    ...
    'header': "ijinkan orang atau kontak",

    'deskripsi': "seseorang di ijinkan, "

                   "Userge ga akan ganggu atau tanggap chat privasi",

    'penggunaan': "{tr}allow [username | userID]\nbalas {tr}allow ke pesan, "

             "lakukan {tr}allow dalam pesan"}, allow_channels=False, allow_via_bot=False)
...
async def allow(message: Message):
    ...
    if userid:
        ...
        if a.matched_count:
            ...
            await message.edit("`sudah di approve`", del_in=3)
...
@userge.on_cmd("nopm", about={
    ...
    'header': "aktifin pertahanan di pesan",

    'description': "seseorang di ijinkan, "

                   "userge ga akan ganggu atau tanggap chat privasi",

    'penggunaan': "{tr}nopm [username | userID]\nbalas {tr}nopm ke pesan, "

             "do {tr}nopm dalam pesan"}, allow_channels=False, allow_via_bot=False)
