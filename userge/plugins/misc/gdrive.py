...
class Worker(_GDrive):
    ...
    async def download(self) -> None:
        ...
        await self._message.edit("`Loading Google Drive Download...`")
        file_id, _ = self._get_file_id()
    ...
    async def copy(self) -> None:
        ...
        if not self._parent_id:
            await self._message.edit("First set parent path by `.gset`", del_in=5)
            return
        await self._message.edit("`Loading Google Drive Copy...`")
        file_id, _ = self._get_file_id()
    ...
    async def get(self) -> None:
        ...
        await self._message.edit("`Loading Google Drive GetDetails...`")
        file_id, _ = self._get_file_id()
        try:
    ...
    async def del_perms(self) -> None:
        ...
        await self._message.edit("`Loading Google Drive DelPermissions...`")
        file_id, _ = self._get_file_id()
        try:
...
@userge.on_cmd("gmake", about={
    'header': "Make Folders in Google Drive",
